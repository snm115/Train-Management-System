...
<h1>Check Sales Report of Chosen Month</h1>
...
<% 
		...
		String qry = "select sum(r.total_fare) rev,month(r.reserve_date) curmonth from Reserves2 r "+
				"where MONTH(r.reserve_date)="+month;
		...
		//make a column
		out.print("<td>");
		out.print("<strong>Total Revenue In Month</strong>");
		out.print("</td>");
		//make a column
		//make a column
		out.print("<td>");
		...
		while (result.next()) {
			...
			out.print("</td>");
			out.print("<td>");
			out.print(result.getString("curmonth"));
			out.print("</td>");
			out.print("</tr>");
